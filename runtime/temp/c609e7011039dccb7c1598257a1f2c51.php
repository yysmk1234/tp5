<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"C:\xampp\htdocs\thinkphp\public/../application/demo\view\hello\setattr.html";i:1485245283;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <div role="tabpanel" class="tab-pane active" id="game_type">
                    <form role="form">
                        <div class="form-group">
                            ...
                            <label for="game_t" style="padding: 10px 0">请输入游戏类型：</label>
                ...
                <div role="tabpanel" class="tab-pane" id="terminal_type">
                    <form role="form">
                        <div class="form-group">
                            ...
                            <br>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            <label for="terminal_t" style="padding: 10px 0">请输入终端类型：</label>
                ...
                <div role="tabpanel" class="tab-pane" id="sex">
                    <form role="form">
                        <div class="form-group">
                            ...
                            <br>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            <label for="sex_t" style="padding: 10px 0">请输入性别类型：</label>
                ...
                <div role="tabpanel" class="tab-pane" id="age_group">
                    <form role="form">
                        <div class="form-group">
                            ...
                            <br>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            <label for="age_t" style="padding: 10px 0">请输入年龄范围：</label>
                ...
                <div role="tabpanel" class="tab-pane" id="game_experience">
                    <form role="form">
                        <div class="form-group">
                            ...
                            <br>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            <label for="game_e" style="padding: 10px 0">请输入游戏经历范围：</label>
                ...
                <div role="tabpanel" class="tab-pane" id="game_year">
                    <form role="form">
                        <div class="form-group">
                            ...
                            <br>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            <label for="game_y" style="padding: 10px 0">请输入游戏年限：</label>
